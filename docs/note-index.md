...
## Keep as Current Implementation Notes
...
Finite-sector rank-scan evidence for the auxiliary construction.

* `notes/bbuf_sewing_ampdim_3_5_note.md`
...
This is a conditional proof-level note.  It is broadly aligned with the current
construction, but it is not the implementation specification: its main theorem
is phrased using a direct formal \(J\)-slot residual backend and an explicit
